...
טבלת `orders` ב-Supabase היא המקום הנכון להאזין לרכישות (למשל webhook ל-Make כשהזמנה עוברת ל-`paid`). **עדיף על נגיעה בקוד תזרים התשלום**, שנבדק end-to-end ואין סיבה לסכן אותו.
